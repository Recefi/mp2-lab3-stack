...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Location = System::Drawing::Point(33, 36);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(448, 32);
			this->textBox1->TabIndex = 0;
			this->textBox1->Text = L"13.6 - (8.7 + 7.3) / 2 + (0.2^2 * 10)";
			...
			this->button1->Size = System::Drawing::Size(51, 32);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox2->Location = System::Drawing::Point(120, 112);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(269, 32);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (!calc.checkExpr()) {
			textBox2->Text = "Error: brackets";
			return;
		}

		try {
			double result = calc.modernCalc();
			textBox2->Text = Convert::ToString(result);
		}
		catch (const char* exception) {
			textBox2->Text = "Error: " + msclr::interop::marshal_as<String^>(exception);
		}
		catch (...) {
			textBox2->Text = "Error";
		}
